const CACHE_NAME = 'fretflow-v1';
const RUNTIME_CACHE = 'fretflow-runtime';
...
// Background sync for offline practice sessions (future enhancement)
...
async function syncPracticeSessions() {
  // Placeholder for syncing offline practice sessions
...
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'FretFlow';
  const options = {
    ...
    data: data.url || '/',
    actions: [
      { action: 'open', title: 'Open FretFlow' },
